...
namespace SeedCacheForCustomerQuerySample
{
    class Program
    {
        ...
        // Generate the Table called Customers & insert 1 Million entities in Batches
        ...
        // Generate the Table called Products & insert 1 Million entities in Batches
        ...
        //Populate Cache 1 with values from the Customers Table
        // The keys in Redis will look like this
        //      Key = cust:Johnie:To
        //      Value = Company 8:243801 (partition key & row key from table storage)
        ...
        //Populate Cache 2 with values from the Products Table
